...
export default function PacePanel() {
  function pacePerMile() {
    // parseFloat ensures decimal input option
    const hours = parseInt(document.runCalculator.hours.value),
      minutes = parseInt(document.runCalculator.minutes.value),
      seconds = parseInt(document.runCalculator.seconds.value),
      mileage = parseFloat(document.runCalculator.mileage.value),
      ...
      secondsPerMile = (seconds + minutes * 60 + hours * 60 * 60) / mileage,
  ...
  function handlePaceCalc() {
    const currentHours = document.runCalculator.hours.value,
      currentMinutes = document.runCalculator.minutes.value,
      currentSeconds = document.runCalculator.seconds.value,
      currentMileage = document.runCalculator.mileage.value;
